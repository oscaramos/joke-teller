// From: https://github.com/testacode/falopabot/blob/master/src/db.js

// https://github.com/jleahred/ortograph/blob/master/data/chistes%20cortos.txt
module.exports = [
  ...
  "- ¿Porque los gallegos ponen una escalera en el mar? para que suba la marea- Dice un niño a su padre: - Papá, ¿los cuernos se quitan? No, hijo, los cuernos se ponen.",
  ...
  "- Sargento, ¿Qué podemos hacer si pisamos una mina? Pues mira recluta, el procedimientohabitual es esparcirse en trocitos por un círculo de 20 metros.",
  ...
  "- ¿Como conseguir que los ojos de un hombre brillen. Metiéndoles una linterna por la oreja. - Había una vez una mujer tan gorda, pero tan gorda, que cuando estaba tomando sol en la playa llegó Green Peace y la devolvió al mar.",
  ...
  "- ¿Qué es para una mujer un pasillo muy largo?... Un laberinto.- Mamá, mamá, (Una cerdita a su madre): ¿porqué tenemos una raja abajo? Por que si la tuvieras arriba serías una alcancía.",
  ...
  "- Pepito le hace la parada a un camión y pregunta: Señor, ¿va para el parque? Sí. Pues que se divierta.- Era un hombre tan pero tan alto... que se tropezó un viernes y cayó un domingo.",
  ...
  "- Era una iglesia tan pequeña, pero tan pequeña, que el cura tenía que dar las hostias de canto.- Va un pez y se ahoga. Va una canica y vuelca. Va un caracol y derrapa. Vas tu y piensas.",
  ...
  "- Dicen que cuando Piscis y Acuario se casan, el matrimonio naufraga.- Un fotógrafo tan tacaño que sólo retrataba del cuello para abajo... Para que no le salieran caras.",
  ...
  "- Hasta mañana si yo quiero (Dios)- Oiga, ¿antes no habían unos cuernos detrás de la barra? ¡No, antes había aquí un espejo!",
  ...
  "- Era un hombre tan honrado, pero tan honrado, que cuando encontró empleo lo devolvió.- En clase de castellano la maestra pregunta: María está disfrutando, a ver, ¿Dónde está el sujeto? Pues encima de ella, maestra.",
  ...
  "- Dos amigos de la infancia: Oye, ¿tu te acostaste con tu mujer antes de casarte? Yo no, ¿y tu? Hombre, yo no sabía que te ibas a casar con ella.- Por qué los de Lepe, en invierno, ponen las manzanas en la ventana? Porque hace un frío que pela…",
  ...
  "- Había una vez una mujer tan gorda pero tan gorda... que cuando se caia de la cama, se caía por los dos lados.- Era un niño tan feo tan feo que le pregunto a su madre: Mama, mama, ¿me quieres? Su madre: Si...pero solo como amigos ehh!!!",
